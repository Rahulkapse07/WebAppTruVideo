...
public class DealersPageTest extends BaseTest {
	...
	public void navigateToDealerPage_And_InitializeDealerPage() {
		getPage().navigate(prop.getProperty("DealerpageUrl"),
	...
	@Test
	public void standard_responcefunctionality() {
	dealerspage.standard_responcefunctionality("Kenility Store","Standard responses to be used for texting");
	}
