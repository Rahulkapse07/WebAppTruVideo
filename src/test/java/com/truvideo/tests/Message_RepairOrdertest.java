...
public class Message_RepairOrdertest extends BaseTest {
	...
	public void verifyfilters(String filtername, String MY,String Whatsapp,String SMS,String Unread,String filter2) {
		switch (filtername) {
		case "My":
		...
		case "My & Whatsapp":
			Assert.assertTrue(MessageScreen_order.verify_with_My_filterBotton(filtername,MY,Whatsapp,SMS,Unread,filter2));
			break;
		...
		case "My & unread":
			Assert.assertTrue(MessageScreen_order.click_My_AND_UNREAD_filterBotton(filtername,MY,Whatsapp,SMS,Unread,filter2));
			break;
	...
	public void click_My_AND_UNREAD_filterBotton() {
		Assert.assertTrue(MessageScreen_order.click_My_AND_UNREAD_filterBotton("My & Unread", "My", "whatsapp", "SMS", "Unread",""));
	}
